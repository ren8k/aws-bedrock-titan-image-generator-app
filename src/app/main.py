...
def main() -> None:
    ...
    input_image_path = "/app/amzn-titan/images/input/dogcat.png"
    input_masks_dir = "/app/amzn-titan/images/mask"
    save_dir = "/app/amzn-titan/images/output"
    # mask_image_path = f"{save_masks_dir}/mask_1.png"
    mask_image_path = f"{input_masks_dir}/mask_dog_rectangle.png"
